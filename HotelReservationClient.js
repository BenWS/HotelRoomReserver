...
async function Main() {
  //create databaseClient object
  var databaseClient = await new HotelReservation.DatabaseClient('Hotel', 'MongoDB://localhost:27017');
  ...
  var customer = await hotel.retrieveCustomer(databaseClient, userName, password);
